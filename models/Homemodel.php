...
class Homemodel extends CI_Model
{
    ...
    public function getProducts(){
        ...
        $products = $this->db->query("SELECT * FROM `products` WHERE featured_product='0'");
    ...
    public function getMobilcate(){
        ...
        $mobile = $this->db->query("SELECT * FROM `products` WHERE pname='HP'");
    ...
    public function getIpad(){
        ...
        $ipad = $this->db->query("SELECT * FROM `products` WHERE featured_product='1' ORDER BY id desc LIMIT 8");
    ...
    public function getIphone(){
        ...
        $ipad = $this->db->query("SELECT * FROM `products` WHERE category='13' ORDER BY id desc LIMIT 4");
        return $ipad->result_array();

    }

    public function getSingleproduct($productid){
        //  $singleprods = $this->db->query("SELECT * FROM `products` WHERE product_title='".$productid."'");
        $singleprods = $this->db->query("SELECT a.*,b.catname FROM `products` AS a LEFT JOIN category AS b ON  b.id = a.category WHERE a.product_title='".$productid."'");
    ...
    public function getCategoryname($categoryname){
        ...
        $catname = $this->db->query("SELECT * FROM `accesories` WHERE category ='$categoryname'");
