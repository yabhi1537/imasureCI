...
//  print_r($headerfooter[0]['usefule_link'] );die();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <header class="hdr-wrap">
                ...
                <div class="row">
                    ...
                    <div class="col-auto hdr-logo">
                        <a href="<?php echo base_url() ?>" class="logo"><img
                                srcset="<?php echo base_url('assets/') ?>image/logo.png 1x, <?php echo base_url('assets/') ?>image/logo.png 2x"
                                alt="Logo"></a>
                    </div>
                        ...
                        <div class="col hdr-topline-left hide-mobile">
                            ...
                            <div class="hdr-line-separate">
                                <ul class="social-list list-unstyled">
                                    <li>
                                        <a href="<?php echo $headerfooter[0]['facebook'] ?>"><i
                                                class="icon-facebook"></i></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo $headerfooter[0]['twiter'] ?>"><i
                                                class="icon-twitter"></i></a>
                                    </li>

                                    <li>
                                        <a href="<?php echo $headerfooter[0]['instagram'] ?>"><i
                                                class="icon-instagram"></i></a>
                                    </li>

                                    <li>
                                        <a href="<?php echo $headerfooter[0]['linkdin'] ?>"><i
        ...
        <div class="hdr-nav hide-mobile nav-holder" style="height: 44px;">
        <ul class="mmenu mmenu-js mmenu--withlabels">
        
        
            <li class="mmenu-item--simple"><a href="<?php echo base_url('') ?>" class="active"><span>Home</span></a>
            
                        </li>

                         <li class="mmenu-item--simple"><a href="<?php echo base_url('about-us') ?>">Company Profile</a>
                           
                         </li>
                     
                         <li class="mmenu-item--simple"><a href="#" >Fluke</a>
                            <div class="mmenu-submenu">
                                <ul class="submenu-list" style="max-height: 436.016px;">
                                <?php
                        foreach($category as $key => $value){
                        
                        ?>
                                <li><a href="<?php echo $value['id'] ?>"><?php echo $value['catname'] ?></a></li>
                                ...
                                <?php
                                      ...
                                      $subcategory  =    $this->db->get('subcategory')->result_array();
                                        foreach($subcategory as $key => $sabValue){
                                            ...
                                            $childsubcategory = $this->db->get('child_subcategory')->result_array();
                         ...
                         <li class="mmenu-item--simple"><a href="<?php echo base_url('blogs') ?>">Blogs</a>
                                        ...
                                        <div class="dropdn-content">
                                            <div class="container">
                                                <form method="get" action="#" class="search search-off-popular">
                                                    ...
                                                    <button type="submit" class="search-button"><i
                                                            class="icon-search"></i></button>
                                                    <a href="#" onclick='clienDiv()' class="search-close js-dropdn-close"><i
                                                            class="icon-close-thin"></i></a>
                                                </form>
                                            </div>
                                            <div class="container col-md-8" id="psearch-resultss" style="height: 400px;overflow-y: auto;">
            ...
            <div class="mobilemenu-content">
                ...
                <div class="mobilemenu-scroll">
                    ...
                    <div class="nav-wrapper show-menu">
                        ...
                        ?>
                            <li>
                                <a href="#"><?php echo $value['catname'] ?><span class="arrow"><i
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav-level-3">
                                            <?php
                                                 ...
                                                 ?>
                                            <li><a
                                                    href="<?php echo base_url('product/'). $proUrl ?>"><?php echo $productsValue['pname'] ?></a>
                                            </li>
                                            <?php
                                                 }
                                   ?>
                    ...
                    <div class="minicart-prd row">
                        <div class="minicart-prd-image image-hover-scale-circle col">
                            <a href="#"><img class="lazyload fade-up"
                                    ...
                                    data-src="images/skins/fashion/products/product-1.png" alt=""></a>
                        </div>
