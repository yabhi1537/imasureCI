                                    ...
                                    <div class="axil-checkout-login toggle-open">
                                        ...
                                        <div class="signin-box">
                                            ...
                                            <div class="form-group mb--0">
                                                <button type="submit" class="axil-btn submit-btn bg-dark text-light">Sign In</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="axil-toggle-box">
                                    ...
                                    <div class="axil-checkout-coupon toggle-open">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="apply-btn">
                                                <button type="submit" class="axil-btn bg-dark text-light">Apply</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="axil-order-summery order-checkout-summery">
                                ...
                                <div class="order-payment-method">
                                    <div class="single-payment">
                                        ...
                                        <p class="text-dark">Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order will not be shipped until the funds have cleared in our account.</p>
                                    </div>
                                    <div class="single-payment">
                                        <div class="input-group">
                                ...
                                <button type="submit" class="axil-btn checkout-btn bg-dark text-light">Process to Checkout</button>
                            </div>
                        </div>
                    </div>
                </form>
