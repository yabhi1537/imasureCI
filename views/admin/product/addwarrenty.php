...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Warrenty/</span> Add Warrenty Details</h4>
        <!-- Basic Layout -->
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php } ?>
                        <form method="post"  action="<?php echo base_url('admin/product/WarrentyController/addwarrenty') ?>" enctype="multipart/form-data">
                            ...
                            <input type='hidden' id='hdn_id[0]' name='hdn_id[0]' value='0' />
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control" name="warrenty[0]" id="warrenty"
                                        placeholder="Enter Warrenty" required>
                                </div>
...
function showValue() {
    ...
    $(".prigrid").append(`<div class="col-md-7 mt-2">
      <input type='hidden' id='hdn_id[` + i + `]' name='hdn_id[` + i + `]' value='` + i + `'/>
        ...
        `]" onkeyup="searchFunction(` + i + `)" placeholder="Enter Warrenty" >
