        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <?php } ?>
                        <form method="post" action="<?php echo base_url('admin/category/CategoryController/addCategory') ?>" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                    <label class="form-label" for="basic-icon-default-fullname">Catefory Image</label>
                                    <div class="input-group input-group-merge">
