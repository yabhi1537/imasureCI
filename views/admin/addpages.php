...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page/</span> Add Page</h4>
        <!-- Basic Layout -->
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <?php } ?>
                        <form method="post" action="<?php echo base_url('admin/PageController/store') ?>" enctype="multipart/form-data">
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    <label class="form-label" for="basic-icon-default-fullname">Page Name</label>
                                    <div class="input-group input-group-merge">
                                        <input type="text" class="form-control" id="basic-icon-default-fullname"
                                            placeholder="Page Name" required name="page" />
                                    </div>
                                </div>
                                <div class="mb-3 col-md-12">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="text" class="form-control" id="basic-icon-default-fullname"
                                            placeholder="Enter Meta Title" required name="title" />
                                    </div>
                                </div>
                                <div class="mb-3 col-md-12">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="text" class="form-control" id="basic-icon-default-fullname"
                                            placeholder="Enter Meta Description" required name="description" />
                                    </div>
                                </div><div class="mb-3 col-md-12">
                                    <label class="form-label" for="basic-icon-default-fullname">Meta Keywords</label>
                                    <div class="input-group input-group-merge">
                                        <input type="text" class="form-control" id="basic-icon-default-fullname"
                                            placeholder="Enter Meta Keywords" required name="keyworsd" />
                                    </div>
                                </div>
