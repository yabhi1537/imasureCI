...
<!-- / Footer -->
  ...
  <!-- Vendors JS -->
  <script src="<?php echo base_url('admin-assets/vendor/libs/apex-charts/apexcharts.js') ?>"></script>

  <!-- Main JS -->
  <script src="<?php echo base_url('admin-assets/js/main.js') ?>"></script>

  <!-- Page JS -->
  <script src="<?php echo base_url('admin-assets/js/dashboards-analytics.js') ?>"></script>
  
  <!-- Place this tag in your head or just before your close body tag. -->
  <script async defer src="<?php echo base_url('buttons.github.io/buttons.js') ?>"></script>
  
</body>


<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template-free/html/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Dec 2022 12:37:21 GMT -->
</html>