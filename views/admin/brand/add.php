...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold"><span class="text-muted fw-light">Brands/</span> Add Brands</h4>
                    ...
                    <?php } ?>
                        <form method="post" action="<?php echo base_url('admin/BrandContgroller/store') ?>" enctype="multipart/form-data">
                            <div class="row">
