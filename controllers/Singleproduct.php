...
class Singleproduct extends CI_Controller
{
    ...
    public function index(){
       ...
       // $pagename= str_replace("-"," ",$this->uri->segment(1));
        ...
        $data['categorynamedata'] = $this->Homemodel->getCategoryname($categoryid);
        
        // print_r($data['categorynamedata']);die();
    ...
    public function addCard(){
     ...
     function SendConfigMail($hdnProTitle,$proname,$name,$email,$mobNum,$message){
        ...
        $html = "<table style='border: 1px solid;'>
            ...
            $this->email->to("sanjayneema@horizoncomputers.co.in,tarun@horizoncomputers.co.in,sonusharma28375@gmail.com");
